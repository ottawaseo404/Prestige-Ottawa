                          ...
                          {services.filter(s =>
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-[#1A2332] font-semibold text-base group-hover/item:text-[#C5A572] transition-colors">{service.title}</div>
                                <div className="text-[#1A2332]/50 text-sm">{service.description}</div>
                              </div>
