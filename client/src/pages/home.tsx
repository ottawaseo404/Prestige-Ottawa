    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 gap-4">
            <div className="flex items-center">
              <img src={logoUrl} alt="Prestige Moving" className="h-16 w-auto" data-testid="img-logo" />
            </div>
      ...
      <section className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center z-10">
          <Badge variant="secondary" className="mb-6 bg-primary/90 text-white border-0" data-testid="badge-location">
            Vancouver's Premium Moving Service
          </Badge>
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight drop-shadow-lg">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center gap-2" data-testid="stat-moves">
              <div className="text-3xl md:text-4xl font-bold text-primary drop-shadow-lg">10,000+</div>
              <div className="text-sm text-white/80">Happy Moves</div>
            </div>
            <div className="flex flex-col items-center gap-2" data-testid="stat-rating">
              <div className="text-3xl md:text-4xl font-bold text-primary drop-shadow-lg">5.0</div>
            ...
            <div className="flex flex-col items-center gap-2" data-testid="stat-insurance">
              ...
              <div className="text-sm text-white/80">WSIB Insured</div>
            </div>
            <div className="flex flex-col items-center gap-2" data-testid="stat-experience">
              <Award className="h-10 w-10 text-primary drop-shadow-lg" />
              <div className="text-sm text-white/80">BBB Accredited</div>
            </div>
          </div>
        </div>
      </section>
