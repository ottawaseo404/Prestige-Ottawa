...
const FAQS: { q: string; a: React.ReactNode }[] = [
  { q: "How much does long distance moving from Ottawa cost?", a: <span>Long distance moving costs depend on volume (cubic feet), distance (kilometres), and services included. Ottawa to Toronto for a 2-bedroom apartment typically runs $2,500–$4,500 with packing included. Ottawa to Vancouver for a 3-bedroom home typically runs $8,000–$14,000. All quotes are binding — the price you receive is the price you pay. See our full <Link href="/how-much-does-moving-cost-ottawa" className="text-[#C5A572] hover:underline">Ottawa moving cost guide</Link> for a detailed breakdown.</span> },
  ...
  { q: "How long does long distance moving from Ottawa take?", a: <span><Link href="/ottawa-to-toronto-movers" className="text-[#C5A572] hover:underline">Ottawa to Toronto</Link>: 1–2 days. <Link href="/ottawa-to-montreal-movers" className="text-[#C5A572] hover:underline">Ottawa to Montreal</Link>: same day. <Link href="/ottawa-to-calgary-movers" className="text-[#C5A572] hover:underline">Ottawa to Calgary</Link>: 5–7 days. <Link href="/ottawa-to-vancouver-movers" className="text-[#C5A572] hover:underline">Ottawa to Vancouver</Link>: 7–10 days. We provide a confirmed delivery date in writing before your move begins — not a vague multi-week range.</span> },
  ...
  { q: "Is my furniture insured during long distance transit?", a: <span>Yes. All long-distance moves include basic valuation coverage of $100,000 in transit insurance. Full replacement value protection is available for an additional premium — strongly recommended for <Link href="/services/antique-moving" className="text-[#C5A572] hover:underline">antiques</Link>, artwork, and high-value electronics. All coverage options are explained during your quote consultation.</span> },
  { q: "Can I pack my own boxes for a long distance move?", a: <span>You can, but we don't recommend it. Items that survive a local move often won't survive 400–4,400 km of highway. If you do pack yourself, our crew inspects and reinforces any boxes before loading. See our <Link href="/services/packing-services" className="text-[#C5A572] hover:underline">professional packing services</Link> for long-distance grade materials designed for thousands of kilometres of transit.</span> },
  { q: "Do you offer storage if my home isn't ready at destination?", a: <span>Yes. If your destination home isn't ready when we load in Ottawa, we offer secure climate-controlled <Link href="/services/storage-solutions" className="text-[#C5A572] hover:underline">storage solutions in Ottawa</Link> on a month-to-month basis. Storage can be added to your move at the quote stage.</span> },
  { q: "What provinces do you move to from Ottawa?", a: <span>We service all Canadian provinces and territories — Ontario, Quebec, BC, Alberta, Saskatchewan, Manitoba, Nova Scotia, New Brunswick, Newfoundland, PEI, and the territories. Key routes: <Link href="/ottawa-to-toronto-movers" className="text-[#C5A572] hover:underline">Ottawa to Toronto</Link>, <Link href="/ottawa-to-montreal-movers" className="text-[#C5A572] hover:underline">Ottawa to Montreal</Link>, <Link href="/ottawa-to-vancouver-movers" className="text-[#C5A572] hover:underline">Ottawa to Vancouver</Link>, <Link href="/ottawa-to-calgary-movers" className="text-[#C5A572] hover:underline">Ottawa to Calgary</Link>, <Link href="/ottawa-to-halifax-movers" className="text-[#C5A572] hover:underline">Ottawa to Halifax</Link>. We do not service US destinations at this time.</span> },
  { q: "How do I get a quote for a long distance move from Ottawa?", a: <span>Call (613) 600-4000 or <Link href="/book" className="text-[#C5A572] hover:underline">book a quote online</Link>. For long distance moves, we arrange either an in-person walkthrough of your home (free, no obligation) or a video walkthrough if preferred. Within 24 hours of the assessment, you'll receive a detailed binding written quote. We never provide verbal estimates for long distance moves.</span> },
  { q: "What makes long distance packing different from local moving?", a: <span>Long distance packing must withstand thousands of kilometres of highway vibration, temperature changes, and the physical forces of a fully loaded truck at highway speed. We use double-wall boxes, anti-vibration foam, furniture pads, stretch wrap, and load bars. See our full <Link href="/services/packing-services" className="text-[#C5A572] hover:underline">packing services page</Link> for details on long-distance grade packing standards. The packing standard for a cross-Canada move is significantly higher than for a local move.</span> },
];
            ...
            <div className="min-w-0 flex-1 space-y-12 xl:space-y-16">
              ...
              <section id="overview">
                ...
                <div className="text-gray-700 leading-relaxed space-y-4">
                  <p><a href="https://ottawalongdistancemovers.com/" target="_blank" rel="noopener noreferrer" className="text-[#C5A572] hover:underline">Long distance moving from Ottawa</a> involves challenges that local moves simply don't have. When your belongings travel hundreds or thousands of kilometres, the stakes for proper packing, documentation, and carrier selection are dramatically higher. A piece of furniture that survives a 10-minute drive across <Link href="/residential-movers-kanata" className="text-[#C5A572] hover:underline">Kanata</Link> won't necessarily survive 4,500 kilometres of highway to Vancouver without the right preparation.</p>
              ...
              <section id="route-guides">
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl border border-gray-100 p-6">
                    <h3 className="text-xl font-bold text-[#1A2332] mb-3"><Link href="/ottawa-to-toronto-movers" className="hover:underline">Ottawa to Toronto Moving</Link></h3>
                    <p className="text-gray-600 leading-relaxed text-sm">The Ottawa–Toronto corridor is Canada's most-moved route, with thousands of Ottawa residents relocating to the GTA annually for employment at Bay Street firms, government relations roles, or tech companies in the University Avenue corridor. At 450 kilometres, the drive is 4–5 hours; our crews typically load in Ottawa on Day 1 and deliver in Toronto on Day 2, with same-day delivery available for early-start loads. The biggest risk on this route is non-binding estimates — Ottawa families report final invoices 40–80% higher than initial estimates from predatory operators. Our binding <Link href="/ottawa-to-toronto-movers" className="text-[#C5A572] hover:underline">Ottawa-to-Toronto quotes</Link> typically run <strong className="text-[#1A2332]">$2,500–$4,500 for 2-bedroom apartments</strong> with professional packing included. Also see <Link href="/moving-from-ottawa-to-mississauga" className="text-[#C5A572] hover:underline">Ottawa to Mississauga</Link> and <Link href="/moving-from-ottawa-to-hamilton" className="text-[#C5A572] hover:underline">Ottawa to Hamilton</Link>.</p>
                  </div>

                  <div className="bg-white rounded-xl border border-gray-100 p-6">
                    <h3 className="text-xl font-bold text-[#1A2332] mb-3"><Link href="/ottawa-to-montreal-movers" className="hover:underline">Ottawa to Montreal Moving</Link></h3>
                    <p className="text-gray-600 leading-relaxed text-sm">At under 200 kilometres, <Link href="/ottawa-to-montreal-movers" className="text-[#C5A572] hover:underline">Ottawa to Montreal</Link> is our most frequent long distance route and is typically completed same-day. Our team navigates Quebec's unique moving environment with fluent French-language building coordination, Montreal-specific elevator and permit requirements, and familiarity with July 1st — Quebec's traditional moving day when hundreds of thousands of residents move simultaneously. We plan July 1st Montreal moves 6–8 weeks out due to the extreme demand concentration. Also see <Link href="/ottawa-to-gatineau-movers" className="text-[#C5A572] hover:underline">Ottawa to Gatineau movers</Link> for cross-river moves. <strong className="text-[#1A2332]">Ottawa to Montreal binding quotes for 2-bedroom apartments typically run $1,800–$3,000</strong>.</p>
                  </div>

                  <div className="bg-white rounded-xl border border-gray-100 p-6">
                    <h3 className="text-xl font-bold text-[#1A2332] mb-3"><Link href="/ottawa-to-vancouver-movers" className="hover:underline">Ottawa to Vancouver Moving</Link></h3>
                    <p className="text-gray-600 leading-relaxed text-sm">Cross-country moves from Ottawa to BC are our most logistically complex long distance service. At 4,400 kilometres, transit typically takes 7–10 days depending on routing and season. These moves require our highest packing standards — double-wall boxes throughout, anti-vibration foam, and <Link href="/services/specialty-item-moving" className="text-[#C5A572] hover:underline">custom crating</Link> for artwork, antiques, and specialty items. Temperature fluctuations between Ottawa and the Rockies make climate-controlled transport essential for sensitive items. We strongly recommend full-service <Link href="/services/packing-services" className="text-[#C5A572] hover:underline">packing services</Link> for all cross-Canada moves. <strong className="text-[#1A2332]">Binding Ottawa to Vancouver quotes for 3-bedroom homes typically run $11,000–$16,000</strong>. See also <Link href="/moving-from-ottawa-to-vancouver" className="text-[#C5A572] hover:underline">moving from Ottawa to Vancouver</Link>.</p>
                  </div>

                  <div className="bg-white rounded-xl border border-gray-100 p-6">
                    <h3 className="text-xl font-bold text-[#1A2332] mb-3"><Link href="/ottawa-to-calgary-movers" className="hover:underline">Ottawa to Calgary / Edmonton Moving</Link></h3>
                    <p className="text-gray-600 leading-relaxed text-sm">Ottawa to Alberta moves have surged with Alberta's economic growth and the movement of federal government employees to regional offices. At 3,300 kilometres to Calgary (5–7 day transit) and 3,500 kilometres to Edmonton, these moves benefit from our direct-fleet advantage — no broker consolidation means your transit time is predictable and your delivery date is confirmed in writing. Many Ottawa-to-Alberta moves include government employees on posting allowances — we're experienced working within DND and federal posting allowance frameworks. See our <Link href="/ottawa-to-calgary-movers" className="text-[#C5A572] hover:underline">Ottawa to Calgary movers</Link> and <Link href="/moving-from-ottawa-to-edmonton" className="text-[#C5A572] hover:underline">Ottawa to Edmonton</Link> pages. <strong className="text-[#1A2332]">Ottawa to Calgary binding quotes for 2-bedroom apartments typically run $5,500–$9,000</strong>.</p>
                  </div>
                </div>

                <div className="mt-6 text-sm text-gray-600 leading-relaxed space-y-2">
                  <p>More routes: <Link href="/ottawa-to-montreal-movers" className="text-[#C5A572] hover:underline">Ottawa to Montreal</Link> · <Link href="/ottawa-to-toronto-movers" className="text-[#C5A572] hover:underline">Ottawa to Toronto</Link> · <Link href="/ottawa-to-vancouver-movers" className="text-[#C5A572] hover:underline">Ottawa to Vancouver</Link> · <Link href="/ottawa-to-calgary-movers" className="text-[#C5A572] hover:underline">Ottawa to Calgary</Link> · <Link href="/ottawa-to-halifax-movers" className="text-[#C5A572] hover:underline">Ottawa to Halifax</Link> · <Link href="/moving-from-ottawa-to-winnipeg" className="text-[#C5A572] hover:underline">Ottawa to Winnipeg</Link> · <Link href="/ottawa-to-new-brunswick-movers" className="text-[#C5A572] hover:underline">Ottawa to New Brunswick</Link> · <Link href="/ottawa-to-nova-scotia-movers" className="text-[#C5A572] hover:underline">Ottawa to Nova Scotia</Link></p>
                  <p>For other long distance routes, call (613) 600-4000 — we cover all Canadian provinces and territories.</p>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1A2332] mb-6">Related Moving Services from Ottawa</h2>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { title: "Ottawa to Toronto Movers", desc: "450 km · 1–2 day transit. Binding quote. Direct crew.", href: "/ottawa-to-toronto-movers" },
                    { title: "Ottawa to Montreal Movers", desc: "200 km · Same-day delivery available. Bilingual crew.", href: "/ottawa-to-montreal-movers" },
                    { title: "Ottawa to Vancouver Movers", desc: "4,400 km cross-country. Climate-controlled. GPS tracked.", href: "/ottawa-to-vancouver-movers" },
                    { title: "Ottawa to Calgary Movers", desc: "3,300 km to Alberta. DND posting allowances accepted.", href: "/ottawa-to-calgary-movers" },
                    { title: "Ottawa to Halifax Movers", desc: "Atlantic Canada. 1,500 km · 3–4 day transit.", href: "/ottawa-to-halifax-movers" },
                    { title: "Ottawa to Gatineau Movers", desc: "Cross-river moves. Same-day. Bilingual coordination.", href: "/ottawa-to-gatineau-movers" },
                    { title: "Ottawa to Winnipeg", desc: "Prairies move. 2,100 km · 3–5 day transit.", href: "/moving-from-ottawa-to-winnipeg" },
                    { title: "Ottawa to Edmonton", desc: "3,500 km to northern Alberta. Binding quote.", href: "/moving-from-ottawa-to-edmonton" },
                    { title: "Residential Moving Ottawa", desc: "Local home moves — apartments, condos, family homes.", href: "/services/residential-moving" },
                    { title: "Packing Services Ottawa", desc: "Long-distance grade packing done by our professionals.", href: "/services/packing-services" },
                    { title: "Storage Solutions Ottawa", desc: "Climate-controlled storage while in transit between homes.", href: "/services/storage-solutions" },
                    { title: "Moving Cost Guide Ottawa", desc: "Understand what your long-distance move will cost.", href: "/how-much-does-moving-cost-ottawa" },
                  ].map(item => (
