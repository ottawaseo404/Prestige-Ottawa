  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [ { "@type": "Question", "name": "Do you disassemble and reassemble furniture in Ottawa?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — disassembly and reassembly is included in your move at no extra charge. We bring all necessary tools. Beds, sectionals, wardrobes, desks, dining tables, and bookshelves are all handled." } }, { "@type": "Question", "name": "Can you move just one piece of furniture in Ottawa?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We handle single-item furniture moves — a sofa, a dining table, a bed frame — within Ottawa. Call (613) 600-4000 for a single-item move quote." } }, { "@type": "Question", "name": "How do you protect furniture during a move?", "acceptedAnswer": { "@type": "Answer", "text": "Every item is fully wrapped in quilted moving blankets before it leaves your home. Corners receive extra foam padding. Sofas and upholstered items get stretch-wrap over the blankets for complete protection." } }, { "@type": "Question", "name": "Can you move furniture without scratching hardwood floors?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We use furniture sliders on all hardwood floors, deploy floor runners through all traffic areas, and lift items rather than drag them. Floor protection is standard on every move." } }, { "@type": "Question", "name": "Do you move antique or valuable furniture in Ottawa?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Antiques and valuable pieces get our highest-level protection protocol: custom padding, crating for extremely fragile items, and careful handling by senior crew members." } } ] })}</script>
