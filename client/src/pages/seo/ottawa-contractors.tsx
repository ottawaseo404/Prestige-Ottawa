            ...
            <article className="prose prose-lg max-w-none prose-headings:text-[#1A2332] prose-headings:font-bold prose-a:text-[#C5A572] prose-a:no-underline hover:prose-a:underline">
              ...
              <section id="about-prestige" className="scroll-mt-24 not-prose mb-14">
                ...
                <div className="space-y-5 text-gray-700 leading-relaxed text-[17px]">
                  ...
                  <p>
                    Our core pricing is transparent and competitive across three packages — Premium (2 movers + truck), Deluxe (3 movers + truck), and Diamond (4 movers + 2 trucks) for large estates and complex moves. All quotes are written, all-inclusive, and guaranteed — call us for your custom rate. Your final invoice always matches your estimate.
                  </p>
