...
import { Phone, CheckCircle, Star, ArrowRight, Home, Shield, Clock, Award, Package, Truck } from "lucide-react";
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={pkg.name} className={`border-2 rounded-md p-6 ${i === 1 ? "border-[#C5A572] bg-[#C5A572]/5" : "border-gray-200 bg-white"}`}>
                  ...
                  <p className="text-[#C5A572] font-bold text-2xl text-center mb-2">{pkg.rate}</p>
