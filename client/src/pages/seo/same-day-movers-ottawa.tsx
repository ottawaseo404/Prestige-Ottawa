      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5 text-gray-700 leading-relaxed">
            ...
            <p>Our same-day moves are priced at standard rates — there is no emergency premium or surcharge for urgent service. We do this because we believe that clients in stressful situations shouldn't face price exploitation on top of everything else. Your rate is the same whether you booked three weeks ago or three hours ago. Call us to confirm availability and pricing.</p>
