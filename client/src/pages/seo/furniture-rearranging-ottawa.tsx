          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="mt-6 bg-[#1A2332] rounded-xl p-5">
                <a href="tel:6136004000" className="text-[#C5A572] font-bold mb-1 flex items-center gap-1.5 cursor-pointer"><Lock className="h-3.5 w-3.5" /> Call for Rate · 3-hour minimum</a>
